...
__all__ = [
    'plug_deit_tiny', 'plug_deit_small',
]
...
class Block(nn.Module):
    ...
    def __init__(
        ...
        self.attn = PLuGAttention(dim, num_heads=num_heads, qkv_bias=qkv_bias, attn_drop=attn_drop, proj_drop=drop)
...
@register_model
def plug_deit_tiny(pretrained=False, **kwargs):
...
@register_model
def plug_deit_small(pretrained=False, **kwargs):
    kwargs = _sanitize_model_kwargs(kwargs)
    model = VisionTransformer(
